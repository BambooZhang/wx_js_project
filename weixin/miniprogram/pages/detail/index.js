...
Page({
  data: {
    // swiper 轮播图 START
    imgUrls: ["https://m.360buyimg.com/n12/jfs/t11317/108/1080677336/325163/f4c2a03a/59fd8b17Nbe2fcca3.jpg!q70.jpg",
  ...
  onLoad: function (op) {
    var goodsId = op.goodsId
    console.log(goodsId)//获取参数详情，用来查询商品详情
    wx.showToast({
      title: "获取商品详情"+goodsId,
      icon: 'succes',
      duration: 1000,
      mask: true
    })
