//index.js
const app = getApp()
const network = require('../../utils/common.js');
...
Page({
  ...
  onLoad: function() {
    ...
    network.networkget("http://120.79.31.191:21006/admin/coin/report/113835/turnCoins?coin=YXT", null, null, null).then((r) => {
      console.log(r)
    });
